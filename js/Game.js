...
if(horse1.isTouching(o1group)){
  ...
  horse1.setCollider ( "rectangle",70,0 ,10255,90);
  o1group.setLifetimeEach(-1);
  o1group.setVelocityEach(0);
  o1group.destroyEach();
  horse1.changeAnimation("j1",jump1);
  if(keyDown("space")){
    horse1.velocityY = 0;
  }
  horse2.setCollider ( "rectangle",70,0 ,10555,90);
  o2group.setLifetimeEach(-1);
  o2group.setVelocityEach(0);
  o2group.destroyEach();
  horse2.changeAnimation("j2",jump2);
  if(keyDown("space")){
    horse1.velocityY = 0;
  }
}
if(horse2.isTouching(o2group)){
  player.distance = plasyer.distance;
  horse1.setCollider ( "rectangle",70,0 ,10255,90);
  o1group.setLifetimeEach(-1);
  o1group.setVelocityEach(0);
  o1group.destroyEach();
